    ...
    return (
        <div className={cn("w-full space-y-6", className)}>
            ...
            <div className="overflow-auto" ref={scrollRef}>
                <div className="relative flex flex-col md:flex-row md:min-w-max md:space-x-8 space-y-6 md:space-y-0 pb-6 pt-2">
                    ...
                    <div className="absolute top-0 bottom-0 left-[25px] w-0.5 bg-border md:hidden" />
                    ...
                    {events.map((event, index) => (
                        ...
                        >
                            ...
                            <div
                                className={cn(
                                    "z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 border-background bg-primary transition-all",
                            ...
                            <Card
                                className={cn(
                                    "md:mt-4 ml-4 md:ml-0 transition-all duration-300 flex-1 cursor-pointer",
                                    activeEvent === event.id ? "border-primary shadow-md" : "opacity-70 hover:opacity-100",
                                    expandedEvent === event.id ? "md:w-[350px]" : "md:w-[250px]",
                            ...
                            >
                                <CardHeader className="pb-2">
                                    <div className="flex flex-col space-y-1">
                                        <CardTitle className="text-sm">{event.company}</CardTitle>
                                        <CardDescription className="text-xs font-medium">{event.title}</CardDescription>
                                    </div>
